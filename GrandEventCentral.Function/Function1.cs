...
namespace FunctionApp9
{
    ...
    public static class Function1
    {
        ...
        public static async Task<Face[]> GetFacialAnalysisResults(string imageUrl)
        {
            ...
            string key1 = Environment.GetEnvironmentVariable("CognitiveServicesKey");
            ...
            var resp = await client.PostAsync(faceUrlBase + reqParams, new StringContent(json, Encoding.UTF8, "application/json"));
